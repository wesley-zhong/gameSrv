...
func init() {
	...
	tcp.RegisterCallPlayerMethod(int32(protoGen.MsgId_PERFORMANCE_TEST_REQ), &protoGen.PerformanceTestReq{}, performanceTest)
	tcp.RegisterCallPlayerMethod(int32(protoGen.MsgId_PERFORMANCE_TEST_RES), &protoGen.PerformanceTestRes{}, performanceTestResFromWorld)

	tcp.RegisterCallPlayerMethod(int32(protoGen.MsgId_DIRECT_TO_GAME), &protoGen.EchoReq{}, directToGame)
