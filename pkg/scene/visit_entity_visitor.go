...
func NewVisitEntityVisitor(selfActor IEntity) *VisitEntityVisitor {
...
func (v *VisitEntityVisitor) GetType() VisitorType {
	return VisitorTypeEntityVisitor
}

// canAddEntity 判断是否可以添加实体
func (v *VisitEntityVisitor) canAddEntity(actor IEntity) bool {
	// TODO: 实现基于实体类型的过滤逻辑
